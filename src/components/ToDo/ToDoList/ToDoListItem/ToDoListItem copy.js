      ...
      <li className="mb-4">
        <label className="custom-label flex">
          <div className="bg-white shadow w-6 h-6 p-1 flex justify-center items-center mr-2">
            <input type="checkbox" className="hidden" checked={this.props.done} onChange={this.onTaskChange} />
          ...
          <span className="select-none">{this.props.task}</span>
        </label>
      </li>
    )
  }
